...
var _ = Describe("PersistentVolumeClaimController controller", func() {
	...
	It("should delete PVC finalizer", func() {
		...
		Eventually(func() error {
			...
			expectedFinalizers := []string{"topols.io/finalizer1", "topols.io/finalizer2", "kubernetes.io/pvc-protection"}
...
func newPVCWithFinalizer() *corev1.PersistentVolumeClaim {
	return &corev1.PersistentVolumeClaim{
		ObjectMeta: metav1.ObjectMeta{
			Name:       "sample",
			Namespace:  "test",
			Finalizers: []string{topols.PVCFinalizer, "topols.io/finalizer1", topols.PVCFinalizer, topols.PVCFinalizer, "topols.io/finalizer2", topols.PVCFinalizer},
		},
